...
<body>
	<form action="adminUserModlist" method="post">
		<div class="popup_layer" style="top: 300px; left: 10px;">
			<div class="pop_in">
				<table class="table table-striped table-dark">
					<thead class="thead-dark">
						<tr>
							<th scope="col" colspan="2">회원 수정</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<th scope="col" class="th">회원 등급 :</th>
							<td><input type="text" name="rating"
								value="${UserList.rating }"></td>
						</tr>
						<tr>
							<th scope="col" class="th">이 름 :</th>
							<td><input type="text" name="name" value="${UserList.name }"></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2"><button type="submit" class="btn btn-info">수정</button>&emsp;<a
